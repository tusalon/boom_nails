...
const urlsToCache = [
  ...
  '/boom_nails/vendor/react.production.min.js',
  '/boom_nails/vendor/react-dom.production.min.js',
  '/boom_nails/vendor/babel.min.js',
  '/boom_nails/vendor/bcrypt.min.js',
  '/boom_nails/vendor/tailwind-browser.js',
  '/boom_nails/vendor/lucide/lucide.css',
  '/boom_nails/vendor/lucide/lucide.woff2',
  '/boom_nails/utils/push-config.js',
  '/boom_nails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/boom_nails/icons/icon-192x192.png',
    badge: '/boom_nails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/boom_nails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/boom_nails/admin.html';
  event.waitUntil(
